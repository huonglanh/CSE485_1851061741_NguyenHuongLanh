<?php
	...
	if(isset($_POST['progskillupdate'])){
		$query="update skills set skillvalue='".$_POST['C Sharp']."' where skill='C Sharp'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		...
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		$query="update skills set skillvalue='".$_POST['Python']."' where skill='Python'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
	}
	if(isset($_POST['graphskillupdate'])){
		$query="update skills set skillvalue='".$_POST['English']."' where skill='English'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		$query="update skills set skillvalue='".$_POST['Korean']."' where skill='Korean'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		$query="update skills set skillvalue='".$_POST['Sociable']."' where skill='Sociable'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		$query="update skills set skillvalue='".$_POST['TeamWork']."' where skill='TeamWork'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
	//	$query="update skills set skillvalue='".$_POST['Leadership']."' where skill='Leadership'";
	//	mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
	}
?>
			<div class="row">
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane fade" id="skills">
							<div class="col-md-6">
								<form method="post">
								<div class="row">
									<div class="col-md-12"><h3>Kĩ năng chuyên môn</h3></div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<?php
							...
							<div class="col-md-6">
								<form method="post">
								<div class="row">
									<div class="col-md-12"><h3>Kĩ năng mềm</h3></div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<?php
