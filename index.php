...
<html>
	...
	<body>
		<div class="container">
			...
			<section id="contact">
				...
				<div class="contact-wrapper">
					...
					<aside class="left-aside">
						<div class="phone-icon"><span class="icon2">d</span></div>
						<div class="call"><?php echo $personaldetails['phone']; ?></div>
						<div class="reach-me"><?php echo $personaldetails['email']; ?><br/><?php echo $personaldetails['website']; ?><br/><br/>QRcode<br/><br/><img src="images/qr.png" /></div>
					</aside>
					<aside class="right-aside">
						<div class="contact_form">
							...
							<form id="contact_form" mathod="post">
								...
								<div class="button">
									...
									<div class="req">Nhớ điền đầy đủ bạn nhé.</div>
								</div>
			...
			<footer id="footer">
				<a href="#" id="toTop"></a>
				COPYRIGHT &copy; 2020 - Nguyễn Hương Lành. Designed by Mee.
			</footer>
		</div>
		<?php
