...
?>
			...
			<div class="row">
				...
				<form method="post">
					...
					<div class="form-group">
					  <div class="input-group">
						<span class="input-group-addon">Nghề nghiệp</span>
						<input type="text" class="form-control" name="designation" value="<?php echo ucfirst($personaldetails['designation']); ?>">
					  </div>
					</div>
					<div class="form-group clearfix">
						<button type="submit" class="btn btn-success pull-right" name="userInfo">Cập nhật</button>
					</div>
				</form>
				</div>
				<div class="col-md-5">
				<form method="post">
					...
					<div class="form-group">
					  <div class="input-group">
						<span class="input-group-addon">Định hướng nghề nghiệp</span>
						<input type="text" class="form-control" name="web" value="<?php echo $personaldetails['website']; ?>">
					  </div>
					</div>
					<div class="form-group clearfix">
						<button type="submit" class="btn btn-success pull-right" name="contactInfo">Cập nhật</button>
					</div>
				</form>
				</div>
			</div>	
